...
$query = "
	  Select arc.typeid,arc.click,addon.question,addon.optionType,addon.optionA,addon.optionB,addon.optionC,addon.optionD,addon.explain,addon.answer,addon.chapterId,addon.falseCount,addon.trueCount From `#@__archives` arc 
