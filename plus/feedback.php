...
if($action=='goodfb')
{
    ...
    echo "<a onclick=\"postBadGood('goodfb',{$aid})\"><i class=\"am-icon-thumbs-up\"></i> <span class=\"am-hide\">支持</span></a>{$row['good']}";
    exit();
}
else if($action=='badfb')
{
    ...
    echo "<a onclick=\"postBadGood('badfb',{$aid})\"><i class=\"am-icon-thumbs-down\"></i><span class=\"am-hide\">反对</span></a>{$row['bad']}";
    exit();
}
//查看评论
/*
