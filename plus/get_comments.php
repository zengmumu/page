...
<div class='decmt-box2'>
  <ul>
    <li class="row"> 
    <div class="col-20"> 
        <a href='' class='plpic'><img src='<?php echo $mface;?>'  height='40' width='40'/></a></div>
    <div class="col-80"> 
  ...
  <ul class="">
    <li class="row  "> 
        <div class="col-20">
            ...
            <a  class='plpic'><img src='<?php echo $mface;?>'  height='40' width='40'/></a>
        </div>
        <div class="col-80">
             <div>
                <a class="title" href=""><?php echo $username; ?></a>
                <span class="time"><?php echo GetDateMk($dtime); ?></span>
             </div>
             <div style="clear:both" class="msg"><?php echo ubb($msg); ?></div>
             <div> <a class="zan" ng-click="zan($event,'goodfb',question.id,<?php echo $id; ?>)"><?php echo $good; ?> <img src="./images/zan.png" width="20" vertical-align="middle" alt=""></a></div>
          <div class="newcomment_act"> <span class='quote'>
            <!--<a href='/plus/feedback.php?aid=<?php echo $id; ?>&fid=<?php echo $id; ?>&action=quote'>[引用]</a>-->
            <!--
            <a href='javascript:ajaxFeedback(<?php echo $id; ?>,<?php echo $id; ?>,"quote");'>[引用]</a> </span></span></div>-->
      </div>  
...
<div id='commetpages'>";
  ...
  if($curpage-1 > 0 )
  {
     // onclick='LoadCommets(".($curpage-1).");'
  echo "<a  ng-click='setCommetPage(".($curpage-1).");'>上一页</a> ";
  }
  ...
  {
  echo ($j==$curpage ? "<strong>$j</strong> " : "<a   ng-click='setCommetPage($j);'>{$j}</a> ");
  }
  if($curpage+1 <= $totalpage )
  {
  echo "<a ng-click='setCommetPage(".($curpage+1).");'>下一页</a> ";
  }
  echo "</div>
";
}