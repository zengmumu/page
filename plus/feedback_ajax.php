...
<div class='decmt-box2'>
  <ul class="am-comments-list am-comments-list-flip">
    <li class="am-g am-comment"> <a href='<?php echo $spaceurl; ?>'  class='plpic am-u-sm-2'><img src='<?php echo $mface;?>'  height='40' width='40' class="am-comment-avatar"/></a>
      <div class="am-u-sm-10">
     <span class="title am-fl"><a href="<?php echo $spaceurl; ?>"><?php echo $username; ?></a></span>
    <div class="comment_act am-fr"><span class="fl"><?php echo GetDateMk($dtime); ?> </span></div>
      <div style="clear:both"><?php echo ubb($msg); ?></div>
      <div class="newcomment_act"><span class="fr"><span id='goodfb<?php echo $id; ?>'> <a href='#goodfb<?php echo $id; ?>' onclick="postBadGood('goodfb',<?php echo $id; ?>);"><i class="am-icon-thumbs-up"></i> <span class="am-hide">支持</span></a>0 </span> <span id='badfb<?php echo $id; ?>'> <a href='#badfb<?php echo $id; ?>' onclick="postBadGood('badfb',<?php echo $id; ?>);"><i class="am-icon-thumbs-down"></i><span class="am-hide">反对</span></a>0 </span> <span class='quote'>
        <!--<a href='/plus/feedback.php?aid=<?php echo $id; ?>&fid=<?php echo $id; ?>&action=quote'>[引用]</a>-->
        <a href='javascript:ajaxFeedback(<?php echo $id; ?>,<?php echo $id; ?>,"quote");'><i class="am-icon-reply"></i><span class="am-hide">引用</span></a> </span></span></div>
       </div>
    </li>
...
<div class="decmt-box2">
  <ul class="am-comments-list am-comments-list-flip">
    <li class="am-g am-comment row"> 
            <div class="col-xs-2">
                 <img src='<?php echo $mface;?>' class="img-circle"  height='40' width='40' />
            </div>
            <div class="col-xs-10">
                <p class="clearfix">
                    <span class="pull-left  small text-muted"> <?php echo $username; ?></span>
                    <span class="pull-right small text-muted"><small><?php echo GetDateMk($dtime); ?><small></span>
                </p>
               <div style="clear:both"><?php echo ubb($msg); ?></div>
                <div></div>
                <p class="text-right">
                   
                        <a href='#goodfb<?php echo $id; ?>' onclick="postBadGood('goodfb',<?php echo $id; ?>);">
                            <img src="/it/images/zan.png" width="20" vertical-align="middle" alt="">  
                             <span id='goodfb<?php echo $id; ?>'> <?php echo $good; ?></span>                        
                        </a>
...
function GetPageList($pagesize, $totalcount)
{
    ...
    echo "
<div id='commetpages'>";
  echo "<span class='c9 am-hide'>{$allpage} / {$totalcount}条评论 </span> ";
  $listsize = 5;
