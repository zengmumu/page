...
else
{
    ...
    $digg = '<div class="diggbox digg_goo" onmousemove="this.style.backgroundPosition=\'left bottom\';" onmouseout="this.style.backgroundPosition=\'left top\';" onclick="postDigg(\'good\','.$id.')">
           
            <div class="digg_num"><i class="am-icon-thumbs-up"></i><img class="am-hide" src="/templets/default/images/zan.png">'.$row['goodpost'].'</div>           
        	</div>
        ';
}
AjaxHead();
